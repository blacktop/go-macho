// Code generated by "stringer -type SpecialPointerAuthDiscriminators,NBKind -output swift_string.go"; DO NOT EDIT.
...
const _NBKind_name = "PartialApplyAsyncFunction"

var _NBKind_index = [...]uint8{0, 12, 25}

func (i NBKind) String() string {
	if i >= NBKind(len(_NBKind_index)-1) {
		return "NBKind(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _NBKind_name[_NBKind_index[i]:_NBKind_index[i+1]]
}
